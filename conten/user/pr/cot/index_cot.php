...
if (isset($_SESSION['username']) && isset($_GET['id_em'])) {
    ...
    // Verifica el rol del usuario es el del coord de tutorias
    if ($_SESSION['rol_em'] !== '1') {
...
<body class="bg-gradient-info" bgcolor="#D4AF37">
    <h1>Coord Tutorias</h1>
    <h1>Bienvenido, </h1>
    <h1 id="lol">soy  <?php echo $username; ?> el super coordinador</h1>
