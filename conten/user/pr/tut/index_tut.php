...
if (isset($_SESSION['username']) && isset($_GET['id_em'])) {
    ...
    // Verifica el rol del usuario es el del tutor
    if ($_SESSION['rol_em'] !== '3') {
...
<body class="bg-gradient-info">
    ...
    <?php
    // ver cierto contenido si el id coincide
    if ($id_em == 262626) {
        echo '<img src="../../../../img/winto.jpg" class="rounded mx-auto d-block custom-image" alt="..." width="150px" height="100px">';
    }
    ?>
