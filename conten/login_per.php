...
if (isset($_SESSION['username'])) {
    // Si el  usuario ya ha iniciado sesión, redirige según su rol
    ...
    switch ($rol_em) {
        ...
        case 5:
            ...
            break;
        default: //Si no es ninguno verificara si coincide con la variable de sesion del estudiante
...
<head>
    ...
    <title>TAJI-Login Personal</title>
...
<body class="bg-gradient-info" action="">
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block">
                                <img src="../img/V4Logo_system.png" class="rounded mx-auto d-block" alt="..." width="450px" height="500px"> 
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                      ...
                                      <img src="../img/LogoEscuela_system.png" class="rounded mx-auto d-block" alt="..." width="150px" height="100px" >
                                        ...
                                        <nav class="navbar navbar-expand-md navbar-dark bg-danger">
                                          ...
                                          <div class="colapse navbar-collapse"  id="menu">
                                            ...
                                            <li class="nav-item">
                                                  <a class="nav-link" href="login_es.php">Estudiante</a>
                                              </li>
                                              <li class="nav-item">                                           
                                                  <a class="nav-link active" href="login_per.php">Personal</a>
                                              </li>
                                          ...
                                          <!-- Termino de tipo de usuario -->
                                    <hr> 
                                          <!-- ingreso de datos del usuario -->
                                    <form class="user" id="login_es_form" action="php/login_per.php" method="POST">
                                        <div class="form-group">
                                            <input type="user" class="form-control form-control-user"
                                                id="user_em" name="user_em"aria-describedby="emailHelp"
                                                placeholder="Usuario" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user"
                                                id="pass_em" name="pass_em" placeholder="Contraseña" required>
                                        </div>                                        
                                        <button type="submit" class="btn btn-primary btn-user btn-block" name="login">Iniciar sesión</button>
                                        
                                    </form>
                                          <!-- fin del procesos de ingreso de datos del usuario -->
